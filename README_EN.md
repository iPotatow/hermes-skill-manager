...
- Top-level Hermes/Codex segmented views; Built-in, Community, and Local share the Hermes source filter
...
Plugin ID: `skill-manager` · Desktop route: `/skill-manager` · Version: `1.8.6`
